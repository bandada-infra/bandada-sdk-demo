...
You just need to activate your API key via the [Bandada Dashboard](https://bandada.pse.dev/) homepage. Then you need to copy & paste the key into the `ADMIN_API_KEY` environment variable.
